...
## Emplacement
Le skill est livré avec ce dépôt dans `skills/mach2/` (racine du repo, pas dans `docs/`).
Lancer depuis la racine du repo : `python skills/mach2/mach2.py <commande>`.
Le fichier `skills/mach2/requirements.txt` liste les dépendances : `pip install -r skills/mach2/requirements.txt`.
