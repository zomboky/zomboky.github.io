#!/usr/bin/env python3
"""Assemblage des pages de l'encyclopédie CAPCOM ZOMBOKY.
...
PAGES = [
    ("index", "Accueil", "CAPCOM ZOMBOKY — L'encyclopédie de la conquête spatiale",
    ...
    ("pionniers", "Pionniers", "Les pionniers de l'astronautique — CAPCOM ZOMBOKY",
...
<div class="bandeau">
  <h1>CAPCOM <span class="rouge">ZOMBOKY</span></h1>
...
FOOT = """
<div class="pied">
  CAPCOM ZOMBOKY — encyclopédie de la conquête spatiale<br>
